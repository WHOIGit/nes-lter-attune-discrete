...
```{r}
data_table <- read.csv(here('attune-transect-discrete-samples-stations.csv'))
...
```{r}
excel_to_template(here('nes-lter-attune-fcm-discrete-transect-info'), 'attune-transect-discrete-samples-stations', rights='CCBY')
```
...
make_eml(here(),
         ...
         data.table='attune-transect-discrete-samples-stations.csv',
         data.table.description='Data table with Syn, picoeuk, and heterotrophic bacteria cell, biovolume, and biomass concentration and time and position sampled',
         data.table.name = 'attune-transect-discrete-samples-stations',
